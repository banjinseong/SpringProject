...
<main class="form-signin w-50 m-auto text-center">
  <form action="/member/login" method="post">
    ...
    <div class="form-floating">
      <input type="text" class="form-control" required="required" id="floatingInput" placeholder="Id" name="username">
      <label for="floatingInput">Id</label>
    </div>
    <div class="form-floating">
      <input type="password" class="form-control" required="required" id="floatingPassword" placeholder="Password" name="password">
